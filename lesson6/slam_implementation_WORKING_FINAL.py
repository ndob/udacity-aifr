...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    for time_index in range(len(data)):
        ...
        xi_x.value[time_index][0] += motion[0] * -1 * motion_confidence
        xi_y.value[time_index][0] += motion[1] * -1 * motion_confidence

        xi_x.value[time_index + 1][0] += motion[0] * motion_confidence
        xi_y.value[time_index + 1][0] += motion[1] * motion_confidence
